...
export function notificationSuppressionReason(args: {
  ...
  // First-party surfaces whose body is author-controlled (briefings, insights
  // generated by our own prompt) skip the noise heuristic. The heuristic is
  // tuned for inbound mail signals and produces false positives on bodies
  // that quote a real "$X sale deadline" or similar.
  const isAuthored = type === "briefing";
