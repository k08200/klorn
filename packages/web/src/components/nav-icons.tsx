// Shared nav SVG icons for the sidebar (NavIcon) and bottom tabs (TabIcon).
// Extracted so the two nav surfaces don't duplicate the same inline paths.
...
export function NavIcon({ type, size = 16, strokeWidth = 1.5 }: NavIconProps) {
  const props = {
    width: size,
    height: size,
    viewBox: "0 0 24 24",
